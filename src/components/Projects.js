...
function Projects() {
  return (
    <section className='flex-col pb-10 mt-10 flex items-center justify-center gap-8 text-main' id='projects'>
      <h2 className='font-main text-2xl lg:text-4xl'>Projects</h2>
      <p className='font-secondary text-base text-center lg:text-lg'>Projects include Personal, OJT, and Work Experiences</p>
      <div className='max-w-screen-2xl w-full flex justify-center items-center'>
        <div className='w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-4 sm:px-6 md:px-8'>
          <div className='col-span-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-auto'>
              ...
              >
                <div className="absolute inset-0 bg-black bg-opacity-80 opacity-0 rounded-lg group-hover:opacity-100 md:group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <div className="text-center flex items-center justify-center gap-2 flex-col p-4">
                    ...
                    <div className='flex items-center justify-center px-3 py-2 rounded-md bg-accent hover:bg-accent/90 transition-colors gap-2'>
                      <a
                        href={project.link}
                        target='_blank'
                        rel='noreferrer'
                        className="text-secondary font-secondary font-medium text-sm"
                      >
                        See More
                      </a>
                      <svg
