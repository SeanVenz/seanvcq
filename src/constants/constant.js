import cpdcheck from '../assets/cpdcheck.png'
...
export const about = [
    { header: 'About Me', text: `Hey! I'm Sean Venz Quijano, a passionate Software Engineer specializing in web development. I thrive on collaborating with like-minded individuals to solve programming challenges. Constantly seeking knowledge and staying up-to-date with industry trends.` },
]
...
<path fill="#b0c1d4" d="M37.005,31.5c-0.975,0-1.91-0.463-2.502-1.237l-5.599-7.321l-5.6,7.321 c-0.592,0.774-1.527,1.237-2.502,1.237h-2.22l8.433-11.028L18.625,9.5h2.22c0.975,0,1.911,0.462,2.502,1.236l5.556,7.266 l5.557-7.266C35.051,9.962,35.987,9.5,36.962,9.5h2.22l-8.391,10.972L39.225,31.5H37.005z"></path><path fill="#66798f" d="M38.17,10l-8.008,10.472L38.213,31h-1.208c-0.825,0-1.604-0.385-2.105-1.04l-5.996-7.841 l-5.996,7.841c-0.501,0.656-1.28,1.04-2.105,1.04h-1.208l8.051-10.528L19.636,10h1.208c0.825,0,1.604,0.385,2.105,1.04l5.954,7.785 l5.954-7.785c0.501-0.656,1.28-1.04,2.105-1.04H38.17 M40.194,9H38.17h-1.208c-1.129,0-2.213,0.536-2.899,1.433l-5.159,6.747 l-5.159-6.747C23.058,9.536,21.974,9,20.845,9h-1.208h-2.024l1.229,1.607l7.544,9.865l-7.586,9.92L17.57,32h2.024h1.208 c1.129,0,2.213-0.536,2.899-1.433l5.202-6.803l5.202,6.803C34.791,31.464,35.875,32,37.005,32h1.208h2.024l-1.229-1.607 l-7.586-9.92l7.544-9.865L40.194,9L40.194,9z"></path><g><path fill="#b0c1d4" d="M10,32.5c-5.238,0-9.5-4.409-9.5-9.828v-4.345C0.5,12.909,4.762,8.5,10,8.5s9.5,4.408,9.5,9.827 v4.172L3.5,22.5v0.172c0,3.765,2.916,6.828,6.5,6.828c1.977,0,3.893-0.996,5.125-2.663c0.628-0.851,1.551-1.338,2.532-1.338h1.469 l-0.248,0.673C17.484,29.957,13.917,32.5,10,32.5z M16.5,19.5v-1.173c0-3.765-2.916-6.827-6.5-6.827s-6.5,3.062-6.5,6.827V19.5 H16.5z"></path><path fill="#66798f" d="M10,9c4.962,0,9,4.185,9,9.327V22L3,22v0.672C3,26.713,6.14,30,10,30 c2.188,0,4.223-1.102,5.527-2.866C16.035,26.447,16.802,26,17.657,26l0.752,0c0,0,0,0,0.001,0.001c-1.322,3.588-4.704,6-8.41,6 c-4.962,0-9-4.185-9-9.328v-4.345C1,13.185,5.038,9,10,9 M3,20h14v-1.673C17,14.287,13.86,11,10,11s-7,3.287-7,7.327V20 M10,8 C4.486,8,0,12.633,0,18.327v4.345C0,28.367,4.486,33,10,33c4.125,0,7.881-2.674,9.348-6.654l0.495-1.344L18.411,25L17.658,25 c-1.142,0-2.211,0.561-2.935,1.54C13.584,28.08,11.819,29,10,29c-3.204,0-5.83-2.663-5.992-6L19,23l1,0v-1v-3.672 C20,12.633,15.514,8,10,8L10,8z M4,19v-0.673C4,14.838,6.692,12,10,12s6,2.838,6,6.327V19H4L4,19z"></path></g>
    ...
    },
    {
        name: "FastAPI", logo:
            <svg viewBox="0 0 128 128">
                <path fill="#009688" d="M64 0C28.654 0 0 28.654 0 64s28.654 64 64 64 64-28.654 64-64S99.346 0 64 0zm0 14c27.57 0 50 22.43 50 50s-22.43 50-50 50-50-22.43-50-50 22.43-50 50-50z"></path><path fill="#009688" d="M64 28.5L44 64h15v35.5L79 64H64V28.5z"></path>
            </svg>
    },
    {
        name: "Next.js", logo:
            <svg viewBox="0 0 128 128">
                <circle cx="64" cy="64" r="64"></circle><path fill="url(#a)" d="M106.317 112.014L49.167 38.4H38.4v51.179h8.614v-40.24l52.54 67.884a64.216 64.216 0 0 0 6.763-5.209z"></path><path fill="url(#b)" d="M81.778 38.4h8.533v51.2h-8.533z"></path><defs><linearGradient id="a" x1="109" y1="116.5" x2="64.5" y2="63.5" gradientTransform="scale(.8)" gradientUnits="userSpaceOnUse"><stop stopColor="#fff"></stop><stop offset="1" stopColor="#fff" stopOpacity="0"></stop></linearGradient><linearGradient id="b" x1="121" y1="54" x2="120.799" y2="106.875" gradientTransform="scale(.8)" gradientUnits="userSpaceOnUse"><stop stopColor="#fff"></stop><stop offset="1" stopColor="#fff" stopOpacity="0"></stop></linearGradient></defs>
            </svg>
    },
    {
        name: "Azure", logo:
            <svg viewBox="0 0 128 128">
                <defs><linearGradient id="azure-a" x1="-960.606" y1="283.397" x2="-960.606" y2="232.659" gradientTransform="matrix(.556 0 0 -.556 597.965 184.795)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#114a8b"></stop><stop offset="1" stopColor="#0669bc"></stop></linearGradient><linearGradient id="azure-b" x1="-938.144" y1="258.641" x2="-946.177" y2="260.969" gradientTransform="matrix(.556 0 0 -.556 597.965 184.795)" gradientUnits="userSpaceOnUse"><stop offset="0" stopOpacity=".3"></stop><stop offset=".071" stopOpacity=".2"></stop><stop offset=".321" stopOpacity=".1"></stop><stop offset=".623" stopOpacity=".05"></stop><stop offset="1" stopOpacity="0"></stop></linearGradient><linearGradient id="azure-c" x1="-947.292" y1="283.397" x2="-947.292" y2="232.659" gradientTransform="matrix(.556 0 0 -.556 597.965 184.795)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#3ccbf4"></stop><stop offset="1" stopColor="#2892df"></stop></linearGradient></defs><path fill="url(#azure-a)" d="M46.09 13.68h32.14L46.09 91.43a5.315 5.315 0 01-5.01 3.54H18.35a5.29 5.29 0 01-4.98-7.13l27.71-70.62a5.315 5.315 0 015.01-3.54z"></path><path fill="#0078d4" d="M97.41 77.57H46.94a2.425 2.425 0 00-1.66 4.19l32.5 30.34c.97.91 2.24 1.42 3.56 1.42h26.31z"></path><path fill="url(#azure-b)" d="M46.09 13.68a5.285 5.285 0 00-5.03 3.63L13.4 87.81a5.29 5.29 0 004.95 7.16h23.28c2.19-.14 4.12-1.46 5-3.42l5.92-14.02 21.05 19.64c.95.88 2.19 1.37 3.47 1.37h26.18l-11.43-33.1-41.08.01 24.12-51.77z"></path><path fill="url(#azure-c)" d="M81.22 13.68H46.03a5.29 5.29 0 00-5.01 3.54l-27.68 70.6a5.29 5.29 0 004.98 7.14h36.14a5.29 5.29 0 004.74-3.54l7.22-17.86 20.99 19.58c.97.91 2.24 1.42 3.56 1.42h26.09l-11.48-33.42-16.73-.01 22.19-47.45z"></path>
            </svg>
    },
    {
        name: "Docker", logo:
...
export const projectData = [
    {
        title: 'CPDCheck',
        link: 'https://provider.cpdcheck.com/',
        img: cpdcheck,
        alt: "CPDCheck Dashboard",
        desc: 'AI-powered CPD assessment platform with automated billing via Xero, Stripe subscriptions, and Azure OpenAI-driven content analysis for financial advisors.',
        category: 'work',
        featured: true,
        techStack: ['Next.js', 'FastAPI', 'Azure', 'Stripe', 'Xero API', 'TypeScript']
    },
    {
        title: 'ADHD Test',
...
export const experience = [
    {
        ...
        type: 'work',
        description: [
            'Co-maintained and developed a CPD (Continuing Professional Development) Assessment API using FastAPI and Python, implementing AI-powered content analysis with Azure OpenAI (GPT-4o-mini).',
            'Built and maintained the assessment frontend using Next.js with TypeScript and Redux for state management.',
            'Implemented automated CPD point allocation, certificate generation, and quiz publishing features.',
            'Integrated Xero accounting platform to enable fully automated billing based on user assessment volume, eliminating manual invoicing and streamlining revenue operations.',
            'Architected and implemented Stripe subscription system with tiered pricing, enabling seamless recurring payments and subscription lifecycle management.',
            'Integrated Azure services including Key Vault for secrets management, SQL Database, and Blob Storage for file handling.',
            'Developed RESTful APIs with JWT authentication, CSRF protection, and rate limiting for security.'
        ],
        skills: ['Python', 'FastAPI', 'Next.js', 'TypeScript', 'Azure', 'SQLAlchemy', 'Pydantic', 'Redux', 'JWT', 'Azure OpenAI', 'Xero API', 'Stripe']
    },
    {
